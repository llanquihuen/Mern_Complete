...
const Form = ({currentId, setCurrentId}) => {
    ...
    return (
        <Paper className={classes.paper}>
            ...
            <Button className={classes.buttonSubmit} variant="contained" color="primary" size="large" type="submit" fullWidth>Aceptar</Button>
            <Button className={classes.buttonSubmit} variant="contained" color="secondary" size="small" onClick={clear} fullWidth>Borrar</Button>
